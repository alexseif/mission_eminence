...
class Partnership
{
    ...
    // #[Vich\UploadableField(mapping: 'partnership', fileNameProperty: 'partnership.name', size: 'partnership.size')]
    #[Vich\UploadableField(mapping: 'partnership_image', fileNameProperty: 'partnership')]
